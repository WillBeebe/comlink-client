...
Nexum signs an encrypted offer, verifies recipient consent and wraps the content key using HPKE only after a signed condition is satisfied.
...
```sh
cd examples
go run ./knowledge-exchange
go test -race ./knowledge-exchange
```
