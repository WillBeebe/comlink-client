...
A signed grant constrains a local tool runner by tool, expiry, revocation and an atomic local budget. A Nexum contract records consent and settlement.
