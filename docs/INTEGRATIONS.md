...
Hermes is **supported** through the [receiving bridge](HERMES.md), tested at its pinned
...
compatibility certification. Hermes is already supported at the pinned revision;
complete its hosted-model acceptance and the Go-native runtime next. Follow with
